...
function setup() {
  ...
  s1 = new Stand(355,300,215,10);
  s2 = new Stand(600,200,150,10);
...
function draw() {
  ...
  fill("red")
  textSize(20);
  text("Drag the hexagonal stone and release it to launch it towards the tower blocks and destroy them", 30, 65);
  pop();
